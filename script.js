...
//         document.write(`Unidade: ${unidade}| Dezena: ${dezena}| Centena: ${centena}| Milhar: ${milhar}`)
...
//             }
//         } else {
//             document.write(`Os lados informados não formamum triangulo.`)
//         }
//         break
...
document.write(`Desafio: Faça um script que calcule as raízes de uma equação do segundo grau, na forma ax2 + bx + c. O script deverá pedir os valores de a, b e c e fazer os testes necessários.`)
